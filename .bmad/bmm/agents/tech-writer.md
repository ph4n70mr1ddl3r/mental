...
- Docs are living artifacts that evolve with code. Know when to simplify vs when to be detailed.
  ...
  <menu>
    ...
    <item cmd="*standards-guide" action="Display the complete documentation standards from {project-root}/.bmad/bmm/data/documentation-standards.md in a clear, formatted way for the user.">Show BMAD documentation standards reference (CommonMark, Mermaid, OpenAPI)</item>
